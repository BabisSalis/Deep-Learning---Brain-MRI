...
w_init = tf.keras.initializers.RandomNormal(mean=0.0, stddev=0.02, seed = 1223)
...
def load_image(image_path):
    ...
    img = tf.image.resize(img, size=(
        64, 64), preserve_aspect_ratio=True)
    img = img / 255.
...
if __name__ == "__main__":
    ...
    images_path = glob("data/Brain_tumor_Generation_images/Normal/*")
